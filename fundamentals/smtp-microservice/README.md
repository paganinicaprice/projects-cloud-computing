...
git clone https://github.com/paganinicaprice/projects-cloud-computing.git cd projects-cloud-computing/smtp-microservice
...
### 5. Forward port for local access
...
Use Swagger UI or `curl` to send an email request:
